<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/services') }}"><i class="icon-star"></i> <span class="nav-link-text">{{ trans('admin.service.title') }}</span></a></li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/works') }}"><i class="icon-plane"></i> <span class="nav-link-text">{{ trans('admin.work.title') }}</span></a></li>
